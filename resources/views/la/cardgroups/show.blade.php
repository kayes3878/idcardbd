...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cardgroup->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<a href="{{ url(config('laraadmin.adminRoute') . '/cardgroups/'.$cardgroup->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cardgroups.destroy', $cardgroup->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cardgroups') }}" data-toggle="tooltip" data-placement="right" title="Back to CardGroups"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'group_type_id')
						@la_display($module, 'card_front_image_link')
						@la_display($module, 'card_Back_image_link')
						@la_display($module, 'view_html')
						@la_display($module, 'description')
						@la_display($module, 'layout')
